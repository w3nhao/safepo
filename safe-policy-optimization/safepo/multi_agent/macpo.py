...
def train(args, cfg_train):
    if args.task in multi_agent_velocity_map:
        ...
        cfg_train["slics"] = args.slices
        cfg_train["use_gpu"] = args.use_gpu
        cfg_train["use_gpu_pipeline"] = args.use_gpu_pipeline
        cfg_train["num_threads"] = args.num_threads
        cfg_train["physics_engine"] = args.physics_engine
        cfg_train["subscenes"] = args.subscenes
        cfg_train["headless"] = args.headless
        cfg_train["device"] = args.device
        cfg_train["device_id"] = args.device_id
        # NOTE: 
        # add cfg_env into cfg_train
